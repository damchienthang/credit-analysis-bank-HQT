    ...
    <div className="p-4 md:p-8 max-w-[1600px] mx-auto space-y-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500 font-medium">Lending Club Portfolio Analysis • Cập nhật: 11/05/2026</p>
        </div>
        <div className="flex gap-3">
          <button className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-xl font-bold text-sm text-gray-600 hover:bg-gray-50 transition-all enterprise-shadow">
            <Filter className="h-4 w-4" /> Lọc dữ liệu
          </button>
              ...
              <tbody className="divide-y divide-gray-50">
                {stateRiskData.map((item, i) => (
                  <tr key={i} className="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="px-8 py-5 text-gray-600 font-medium">{item.loans.toLocaleString()}</td>
